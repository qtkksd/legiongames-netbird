...
const file_management_proto_rawDesc = "" +
	...
	"\vSyncRequest\x12.\n" +
	"\x04meta\x18\x01 \x01(\v2\x1a.management.PeerSystemMetaR\x04meta\"\xa3\x03\n" +
	"\fSyncResponse\x12?\n" +
	...
	"NetworkMap\x12*\n" +
	"\x06Checks\x18\x06 \x03(\v2\x12.management.ChecksR\x06Checks\x12F\n" +
	"\x10sessionExpiresAt\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x10sessionExpiresAt\"A\n" +
	...
	"\fcapabilities\x18\x12 \x03(\x0e2\x1a.management.PeerCapabilityR\fcapabilities\"\xfc\x01\n" +
	"\rLoginResponse\x12?\n" +
	"\rnetbirdConfig\x18\x01 \x01(\v2\x19.management.NetbirdConfigR\rnetbirdConfig\x126\n" +
	"\n" +
	"peerConfig\x18\x02 \x01(\v2\x16.management.PeerConfigR\n" +
	"peerConfig\x12*\n" +
	"\x06Checks\x18\x03 \x03(\v2\x12.management.ChecksR\x06Checks\x12F\n" +
	"\x10sessionExpiresAt\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x10sessionExpiresAt\"f\n" +
	"\x18ExtendAuthSessionRequest\x12\x1a\n" +
	"\bjwtToken\x18\x01 \x01(\tR\bjwtToken\x12.\n" +
	"\x04meta\x18\x02 \x01(\v2\x1a.management.PeerSystemMetaR\x04meta\"c\n" +
	"\x19ExtendAuthSessionResponse\x12F\n" +
	"\x10sessionExpiresAt\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x10sessionExpiresAt\"y\n" +
	...
	"\rAmneziaConfig\x12\x13\n" +
	"\x02jc\x18\x01 \x01(\x05H\x00R\x02jc\x88\x01\x01\x12\x17\n" +
	"\x04jmin\x18\x02 \x01(\x05H\x01R\x04jmin\x88\x01\x01\x12\x17\n" +
	"\x04jmax\x18\x03 \x01(\x05H\x02R\x04jmax\x88\x01\x01\x12\x13\n" +
	"\x02s1\x18\x04 \x01(\x05H\x03R\x02s1\x88\x01\x01\x12\x13\n" +
	"\x02s2\x18\x05 \x01(\x05H\x04R\x02s2\x88\x01\x01\x12\x13\n" +
	"\x02h1\x18\x06 \x01(\rH\x05R\x02h1\x88\x01\x01\x12\x13\n" +
	"\x02h2\x18\a \x01(\rH\x06R\x02h2\x88\x01\x01\x12\x13\n" +
	"\x02h3\x18\b \x01(\rH\aR\x02h3\x88\x01\x01\x12\x13\n" +
	"\x02h4\x18\t \x01(\rH\bR\x02h4\x88\x01\x01\x12\x13\n" +
	"\x02i1\x18\n" +
	" \x01(\tH\tR\x02i1\x88\x01\x01\x12\x13\n" +
	"\x02i2\x18\v \x01(\tH\n" +
	"R\x02i2\x88\x01\x01\x12\x13\n" +
	"\x02i3\x18\f \x01(\tH\vR\x02i3\x88\x01\x01\x12\x13\n" +
	"\x02i4\x18\r \x01(\tH\fR\x02i4\x88\x01\x01\x12\x13\n" +
	"\x02i5\x18\x0e \x01(\tH\rR\x02i5\x88\x01\x01B\x05\n" +
	"\x03_jcB\a\n" +
	"\x05_jminB\a\n" +
	"\x05_jmaxB\x05\n" +
	"\x03_s1B\x05\n" +
	...
	"autoUpdate\x12D\n" +
	"\ramneziaConfig\x18\t \x01(\v2\x19.management.AmneziaConfigH\x00R\ramneziaConfig\x88\x01\x01\x12\x1d\n" +
	"\n" +
	"address_v6\x18\n" +
	" \x01(\fR\taddressV6B\x10\n" +
	"\x0e_amneziaConfig\"R\n" +
	...
	"\x03Job\x12\x1c.management.EncryptedMessage\x1a\x1c.management.EncryptedMessage\"\x00(\x010\x01\x12Q\n" +
	"\x11ExtendAuthSession\x12\x1c.management.EncryptedMessage\x1a\x1c.management.EncryptedMessage\"\x00\x12L\n" +
...
var file_management_proto_goTypes = []any{
	...
	(*AmneziaConfig)(nil),                  // 33: management.AmneziaConfig
...
var file_management_proto_depIdxs = []int32{
	...
	67, // 31: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	28, // 32: management.ProtectedHostConfig.hostConfig:type_name -> management.HostConfig
	40, // 33: management.PeerConfig.sshConfig:type_name -> management.SSHConfig
	35, // 34: management.PeerConfig.autoUpdate:type_name -> management.AutoUpdateSettings
	33, // 35: management.PeerConfig.amneziaConfig:type_name -> management.AmneziaConfig
...
func file_management_proto_init() {
	...
	file_management_proto_msgTypes[26].OneofWrappers = []any{}
	file_management_proto_msgTypes[47].OneofWrappers = []any{
		(*PortInfo_Port)(nil),
		(*PortInfo_Range_)(nil),
	}
	type x struct{}
