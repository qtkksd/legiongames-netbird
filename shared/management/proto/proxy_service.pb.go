...
const file_proxy_service_proto_rawDesc = "" +
	...
	"management\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfd\x02\n" +
	...
	"\x11supports_crowdsec\x18\x03 \x01(\bH\x02R\x10supportsCrowdsec\x88\x01\x01\x12\x1d\n" +
	"\aprivate\x18\x04 \x01(\bH\x03R\aprivate\x88\x01\x01\x12=\n" +
	"\x18supports_private_service\x18\x05 \x01(\bH\x04R\x16supportsPrivateService\x88\x01\x01B\x18\n" +
	"\x16_supports_custom_portsB\x14\n" +
	"\x12_require_subdomainB\x14\n" +
	"\x12_supports_crowdsecB\n" +
	"\n" +
	"\b_privateB\x1b\n" +
	"\x19_supports_private_service\"\xe6\x01\n" +
	...
	"\x15initial_sync_complete\x18\x02 \x01(\bR\x13initialSyncComplete\"\xf7\x03\n" +
	...
	"\x14session_idle_timeout\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\x12sessionIdleTimeout\x12'\n" +
	"\x0fdirect_upstream\x18\a \x01(\bR\x0edirectUpstream\x1a@\n" +
	...
	"\rcrowdsec_mode\x18\x05 \x01(\tR\fcrowdsecMode\"\x80\x04\n" +
	"\fProxyMapping\x126\n" +
	...
	"listenPort\x12O\n" +
	"\x13access_restrictions\x18\f \x01(\v2\x1e.management.AccessRestrictionsR\x12accessRestrictions\x12\x18\n" +
	"\aprivate\x18\r \x01(\bR\aprivate\"?\n" +
	...
	"\rsession_token\x18\x02 \x01(\tR\fsessionToken\"\xda\x02\n" +
	...
	"\rerror_message\x18\x05 \x01(\tH\x00R\ferrorMessage\x88\x01\x01\x12P\n" +
	"\x10inbound_listener\x182 \x01(\v2 .management.ProxyInboundListenerH\x01R\x0finboundListener\x88\x01\x01B\x10\n" +
	"\x0e_error_messageB\x13\n" +
	"\x11_inbound_listener\"o\n" +
	"\x14ProxyInboundListener\x12\x1b\n" +
	"\ttunnel_ip\x18\x01 \x01(\tR\btunnelIp\x12\x1d\n" +
	"\n" +
	"https_port\x18\x02 \x01(\rR\thttpsPort\x12\x1b\n" +
	"\thttp_port\x18\x03 \x01(\rR\bhttpPort\"\x1a\n" +
	...
	"\rsession_token\x18\x02 \x01(\tR\fsessionToken\"\xdc\x01\n" +
	"\x17ValidateSessionResponse\x12\x14\n" +
	"\x05valid\x18\x01 \x01(\bR\x05valid\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x1d\n" +
	"\n" +
	"user_email\x18\x03 \x01(\tR\tuserEmail\x12#\n" +
	"\rdenied_reason\x18\x04 \x01(\tR\fdeniedReason\x12$\n" +
	"\x0epeer_group_ids\x18\x05 \x03(\tR\fpeerGroupIds\x12(\n" +
	"\x10peer_group_names\x18\x06 \x03(\tR\x0epeerGroupNames\"P\n" +
	"\x19ValidateTunnelPeerRequest\x12\x1b\n" +
	"\ttunnel_ip\x18\x01 \x01(\tR\btunnelIp\x12\x16\n" +
	"\x06domain\x18\x02 \x01(\tR\x06domain\"\x84\x02\n" +
	"\x1aValidateTunnelPeerResponse\x12\x14\n" +
	"\x05valid\x18\x01 \x01(\bR\x05valid\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x1d\n" +
	"\n" +
	"user_email\x18\x03 \x01(\tR\tuserEmail\x12#\n" +
	...
	"\x0epeer_group_ids\x18\x06 \x03(\tR\fpeerGroupIds\x12(\n" +
	"\x10peer_group_names\x18\a \x03(\tR\x0epeerGroupNames\"\x81\x01\n" +
	...
	"\x12PROXY_STATUS_ERROR\x10\x052\xb8\x06\n" +
	"\fProxyService\x12_\n" +
	...
	"\x0fValidateSession\x12\".management.ValidateSessionRequest\x1a#.management.ValidateSessionResponse\x12c\n" +
	"\x12ValidateTunnelPeer\x12%.management.ValidateTunnelPeerRequest\x1a&.management.ValidateTunnelPeerResponseB\bZ\x06/protob\x06proto3"
...
func file_proxy_service_proto_init() {
	...
	file_proxy_service_proto_msgTypes[21].OneofWrappers = []any{}
	file_proxy_service_proto_msgTypes[28].OneofWrappers = []any{
